        ...
        <form class="space-y-10" action="#" @submit.prevent="submit">
            ...
            <div class="space-y-6">
                ...
                <ui-input type="email" name="email" id="email" v-model="form.email" :error="form.errors.email"
                    label="Online Post" placeholder="Your Online Post Address" />
                <ui-input type="password" name="password" id="password" v-model="form.password"
                    :error="form.errors.password" label="Password" placeholder="••••••••" required />
                <ui-input type="password" name="password_confirmation" id="password_confirmation"
                    ...
                    label="Re-Type Password" placeholder="••••••••" required />
            </div>
            ...
            <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                Have an Acount?
                <Link href="/login" class="text-blue-700 hover:underline dark:text-blue-500">Sign In</Link>
            </div>
        </form>
    </ui-card>
</template>